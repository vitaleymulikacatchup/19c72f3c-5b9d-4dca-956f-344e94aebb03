...
export const metadata: Metadata = {
  title: "TacticalArms - Professional Tactical Equipment & Firearms",
  description: "Licensed federal firearms dealer serving law enforcement, military, and authorized civilians. Premium tactical equipment, professional service, 15+ years experience.",
  keywords: "tactical equipment, firearms dealer, law enforcement gear, military weapons, tactical accessories, professional firearms",
  metadataBase: new URL("https://tacticalarms.com"),
  alternates: {
    canonical: "https://tacticalarms.com"
  },
  openGraph: {
    title: "TacticalArms - Professional Tactical Equipment & Firearms",
    description: "Licensed federal firearms dealer serving law enforcement, military, and authorized civilians with premium tactical equipment.",
    siteName: "TacticalArms",
    images: [
      {
        url: "https://images.pexels.com/photos/9250/green-attraction-war-museum.jpg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Professional tactical equipment showcase"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "TacticalArms - Professional Tactical Equipment",
    description: "Licensed federal firearms dealer with premium tactical equipment for professionals",
    images: ["https://images.pexels.com/photos/9250/green-attraction-war-museum.jpg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
